...
export const metadata: Metadata = {
  ...
  description: 'Explore all products currently on sale.',
}

export default async function SalePage() {
  // Reuse the All Products collection data to keep layout identical
  ...
  return (
    <div className="container">
      <div>
        <Breadcrumb breadcrumbs={breadcrumbs} currentPage={'Sale'} className="py-3.5" />
        ...
        <main className="">
          <div className="flex flex-col items-center py-14 text-center lg:py-20">
            ...
            <Text className="mt-5 max-w-xl">Browse items on sale across our catalog.</Text>
          </div>
