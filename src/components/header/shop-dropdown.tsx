      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-1/2 z-50 mt-3 w-screen max-w-6xl -translate-x-1/2 transform"
          >
            <div className="overflow-hidden rounded-2xl bg-white font-sans shadow-2xl ring-1 ring-black/5 dark:bg-zinc-900 dark:ring-white/10">
              <div className="p-8">
                      ...
                      >
                        <div className="relative overflow-hidden rounded-lg">
                          ...
                          <div className="pointer-events-none absolute inset-x-0 bottom-3 flex justify-center px-4">
                            <h3 className="font-sans font-bold text-zinc-950 text-lg text-center uppercase tracking-[0.02em]">
                              {category.name}
                            </h3>
                          </div>
                        </div>
                        ...
                        <div className="p-4">
                          <p className="mt-1 text-sm/6 font-sans text-zinc-950">
